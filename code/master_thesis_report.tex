		...
		\section{Methods and Results}
			\subsection{Consumer resource model with cross feeding interactions}
				...
				\subsection{A metric of community cohesion}
					The cohesion of a community is ultimately determined by the nature of the interactions between its members. Since I am considering two types of interactions, namely, competition, and mutualisms, the simplest way to render them into a mathematical expression is to subtract them.
					\begin{linenomath*}
